/*---------------------------------------------------------------------------------
    ...
    Dodge'em portage by monsieurjplus
...
void DrawScene(Mtx v, GXTexObj texture) {
    ...
    for (int loop_m = 0; loop_m < numtriangles; loop_m++) {
        ...
        printf("%f %f %f %f %f",sector1.triangle[loop_m].vertex[0].x,sector1.triangle[loop_m].vertex[0].y,sector1.triangle[loop_m].vertex[0].z,sector1.triangle[loop_m].vertex[0].u,sector1.triangle[loop_m].vertex[0].v);    
